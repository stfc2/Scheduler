        ...
        if($planetary_weapons == 0) {
            ...
            if($this->dest['user_id'] == INDEPENDENT_USERID) {
                ...
                if(!empty($this->move['user_alliance']) && $this->move['user_alliance_status'] > 2)
                    $sql = 'INSERT INTO settlers_relations SET planet_id = '.$this->move['dest'].', user_id = '.$this->move['user_id'].', alliance_id = '.$this->move['user_alliance'].', race_id = '.$this->move['race_id'].', timestamp = '.time().', log_code = 11, mood_modifier = - 30';
                else
                    $sql = 'INSERT INTO settlers_relations SET planet_id = '.$this->move['dest'].', user_id = '.$this->move['user_id'].', race_id = '.$this->move['race_id'].', timestamp = '.time().', log_code = 11, mood_modifier = - 30';
